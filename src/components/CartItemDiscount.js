...
function CartItemDiscount(props) {
    return (
        <div>
            ...
            <div>
                <div className={Styles.item_product}>
                    ...
                    <div className={Styles.item_product_image}>
                        <img alt="" src="https://cf.shopee.vn/file/d79fcd5348aba86a15c07a1ddfae7e0f_tn" width="100%" height="100%" />
                    </div>
                    <div className={Styles.item_product_info_box}>
                        <p>Máy ép chậm rau củ quả</p>
                        <div onClick={()=>props.changeTypeItem(1)} className={Styles.type}>
                            <p>Phân loại: xanh</p>
