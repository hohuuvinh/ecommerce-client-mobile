            ...
            <div className={Styles.box_icon_main}>
              <div className={Styles.icon_box}>
                <div style={{width: '40px'}}>
                  <img src="images/icons/ic_pending.svg" width="100%" height="100%" />
                </div>
                <p>Chờ xác nhận</p>
              </div>
              <div className={Styles.icon_box}>
                <div>
                  <img src="images/icons/ic_waiting.svg" width="100%" height="100%" />
                </div>
                <p>Chờ lấy hàng</p>
              </div>
              <div className={Styles.icon_box}>
                <div style={{width: '55px'}}>
                  <img src="images/icons/ic_ship.svg" width="100%" height="100%" />
                </div>
                <p>Đang giao</p>
              </div>
              <div className={Styles.icon_box}>
                <div>
                  <img src="images/icons/ic_review.svg" width="100%" height="100%" />
                </div>
                <p>Đánh giá</p>
              </div>
            </div>
