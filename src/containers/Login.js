        ...
        <div>
            <form onSubmit={submitFormLogin}>
                ...
                <div className={Styles.input_box_main}>
                    <p className={`cl ${Styles.login_title}`}>Đăng nhập</p>
                    ...
                    <div className={Styles.password_input_box}>
                        <input type={hideShowPassword ? "text" : "password"} name="password" value={formData.password} onChange={handleChange} placeholder="Mật khẩu" />
                        ...
                        <div style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                            <div className={Styles.box_error}>
                                ...
                                <div className={Styles.text_error}>
                                    <p className="mb-0">login failed, please try again later or use another login method</p>
                                </div>
                            </div>
                        </div>
                }
                <div className={Styles.box_foter}>
                    <button disabled={!checkSubmit || formData.password.length < 8} className={checkSubmit && formData.password.length > 8 ? `${Styles.box_button_login} ${Styles.enable} bg` : `${Styles.box_button_login} bg`}>
                        Đăng nhập
                    </button>
                    <NavLink exact to="/quen-mat-khau" onClick={props.onProgress}>
                    <p className={Styles.forgot_password}>Quên mật khẩu</p>
                    </NavLink>
                    <p className={Styles.login_sms}>Đăng nhập với SMS</p>
                    <div className="clear__both" />
                    ...
                    <div className={Styles.move_login}>
                        <p>Bạn chưa có tài khoản?
                            <NavLink exact to="/dang-ky" onClick={props.onProgress}>
                                <a> Đăng ký</a>
                            </NavLink>
                        </p>
                    </div>
